        ...
        <div className="user-manager">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-md mb-xl">
                ...
                <div className="flex items-center gap-md">
                    <div className="flex items-center gap-sm px-md py-sm" style={{ borderRadius: 'var(--radius-md)' }}>
                    ...
                    <tbody>
                        {filteredUsers.map((u) => (
                            <tr key={u._id} style={{ borderBottom: '1px solid var(--color-border)' }}>
                                ...
                                <td style={{ padding: 'var(--spacing-md)', display: "flex", justifyContent: "flex-end" }}>
                                    <button
