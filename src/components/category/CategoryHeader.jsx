...
const CategoryHeader = ({ title, description }) => {
    return (
        <div className="mb-12 border-b border-gray-100 pb-12">
            ...
            <h1 className="text-6xl md:text-7xl font-black font-serif italic tracking-tighter text-slate-900 mb-8 leading-[1.05]">
                {title || 'Section Archive'}
            </h1>
            
            <p className="text-xl font-serif text-gray-500 max-w-2xl leading-relaxed italic">
